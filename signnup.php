    ...
    <div class=" container py-5 ">
        ...
        <div class="login-wrapper d-flex justify-content-center align-items-center min-vh-100 ">
            ...
            <div class="login-card p-4 shadow rounded-4 bg-white" style="width: 100%; max-width: 450px;">
                <h3 class="text-center mb-4 d-flex bg-light text-dark">SignUp (Smart ERP System) </h3>
                <form action="login.php" method="POST">
                    <div class="mb-3">
                ...
                <p class="text-center mt-3 mb-0 text-muted">Welcome To Smart ERP System</a></p>
            </div>
        </div>
    </div> 
